...
public class FacebookAdAnalyzer {
	...
	Job job_obj = new Job(conf, "FacebookAdAnalyzer");
	// setting name of main class
	job_obj.setJarByClass(FacebookAdAnalyzer.class);
	//name of mapper class
	job_obj.setMapperClass(FbMapper.class);
		// name of reducer class
	job_obj.setReducerClass(FbReducer.class);
