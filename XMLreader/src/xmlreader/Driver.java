...
public class Driver {
	...
	Job job_obj = new Job(conf, "Custom Input Formatter");
        job_obj.setInputFormatClass(XMLInputFormat.class);  //set your own input format class
	// setting name of main class
	job_obj.setJarByClass(Driver.class);
	//name of mapper class
	job_obj.setMapperClass(XMLMapper.class);
		// name of reducer class
	//job_obj.setReducerClass(MyReducer.class);
		// name of combiner class
	job_obj.setOutputKeyClass(LongWritable.class);
